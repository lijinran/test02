(function (global) {
     ...
     */
    proto.define = function (id,deps,factory, cache) {
        debug('scrat.define', '[' + id + ']');
        /*        if(type(deps)=="array"){
         if(deps.length){
         var _onload=function( require,exports, module){
         define.call(scrat,id,factory,cache)
         }
         scrat.async(deps,_onload)
         }else{
         define.call(scrat,id,factory,cache)
         }
         return
        ...
        var deps=deps,
            factory=factory;
        if(type(deps)=="array"){
            if(type(factory)!=="function"){return}
    ...
    proto.alias = function (name, alias) {
        ...
        /*var hasAlias=aliasMap[name]||(/\.js$/.test(name)?aliasMap[name.replace(/\.js$/,"")]:aliasMap[name+".js"]);
         while (hasAlias && name !== hasAlias) {
         switch (type(hasAlias)) {
         case 'function':
         name = hasAlias(name);
         break;
         case 'string':
    ...
    rproto.push = function () {
        ...
        each(args, function (arg) {
            ...
            } else if (that.depended[arg] || res.loaded) return;
    ...
    function require(name) {
        ...
        if (type(module.factory) === 'function') {
            ...
            try {
                var _module=factory.call(scrat, require, module.exports = {}, module);
            } catch (e) {
                e.id = id;
        ...
        return _module?(module.exports=_module):module.exports;
    }
