...
Vue.component('vue-marquee', {
    template: `<div class="m-tipRollDiv g-con">
                <div class="m-ScrollAround colorfff">
                    <!--<span class="pull-left u-left"><img src="./static/" alt=""></span>-->
                    <div class="u-right">
                        ...
                        <ul id="marquee" v-else="timeText==1" >
                                  <li v-for="el in scrollWin" class="colorfff" v-html="el" style="width: 100%;margin-right:0"></li> 
                        </ul>
                    </div>
